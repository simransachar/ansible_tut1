...
INSERT INTO `lab_computerlab` VALUES (2,'INST737','Computer lab for INST 737','Digging into Data','INST737_Spring2013','Spring 2015','Jordan Boyd-Graber','ssachar','ami-ddb239b4','2014-05-27 17:27:37','Username = inst737, password = datascience','RDP, SSH, NX Viewer','vcl_lab','t2.micro'),(4,'INST 733','Computer Lab for Database Design INST 733','Database Design','INST733_Spring2013','Spring 2013','Vedat Diker','Dave','ami-dfd347b6','2014-06-23 22:30:04','Username = inst733, password = norelation','RDP, SSH, NX Viewer','vcl_lab','t2.micro'),(8,'Digital Curation - ARCGIS Unlocked','Computer Lab for INST640 - Unlocked','Digital Curation','INST640','Fall 2014','Richard Marciano','ssachar','ami-d48f07bc','2014-11-12 14:34:47','Username = Administrator, Password = Dclab@umd','RDP, SSH, NX Viewer','vcl_lab','t2.micro'),(9,'Big Data - INST 767','Computer Lab for INST 767','Big Data Infrastructure','INST767_Spring2015','Spring 2015','Jimmy Lin','ssachar','ami-1cca8d74','2015-01-29 10:28:06','Username = inst737, password = datascience','RDP, SSH, NX Viewer','vcl_lab','t2.micro'),(10,'Demo WIN','DEMO FOR WIN','WINDOWS RAW IMAGE','WIN','FALL 20165','XYZ','ssachar','ami-c76e84ac','2015-06-09 13:58:34','Username = inst737, password = datascience','RDP, SSH, NX Viewer','vcl_lab','t2.micro'),(11,'Development of Internet Applications - INST 743','Computer Lab for INST 743','Development of Internet Applications','INST743_Fall2015','Fall 2015','Jen Golbeck','ssachar','ami-276bec4c','2015-07-08 22:27:50','Username = inst743, password = perl','RDP, SSH','vcl_lab','t2.micro'),(12,'Ubuntu Characterization Test','Ubuntu Characterization Test','Ubuntu Characterization Test','TEST-UB','Fall 2015','Allison','ssachar','ami-c9c5a6ac','2015-09-05 01:03:46','password: splendidmachine1','RDP, SSH','vcl_lab','t2.micro'),(13,'Ubuntu Email Curation','Ubuntu Email Curation','Ubuntu Email Curation','Ubuntu_Email','Fall 2015','Jesse Johnston','ssachar','ami-35b4c450','2015-10-13 18:16:14','password: splendidmachine1','RDP, SSH','vcl_lab','t2.micro');
...
INSERT INTO `lab_instructor` VALUES (2,'ssachar','i-181f42b8','INST737_Spring2013','infoadmin','','Username = inst737, password = datascience'),(6,'ssachar','i-773964d7','INST737_Spring2013','ssachar','','Username = inst737, password = datascience'),(7,'ssachar','i-3c35699c','INST737_Spring2013','Dave','','Username = inst737, password = datascience'),(40,'ssachar','i-63f312c0','TEST-UB','ssachar','','password: splendidmachine1'),(41,'ssachar','i-0ef716ad','INST743_Fall2015','ssachar','','Username = inst743, password = perl');
...
-- Dump completed on 2015-10-13 23:23:24
